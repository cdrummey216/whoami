...
What are the properties of a _self_? What also can be known based on this knowledge? How does one live going forward? To answer these questions, I present propositional mathematics, concentrated philosophy, and _living_ as art. The intention behind this document is to _know more_. In other words, what else can be known based on this knowledge? By defining the self as a value, we are able to observe the self as an _object in reality_ while also understanding the self as an _object of our own perception_. In the following, a proposition is given that the value of the _sense of self_ is the same value that is seen repeatedly across the universe in everything from spiral of a nautilus shell to the shape of the Milky Way galaxy to the length of your arm. This value is called the divine proportion, phi, or 1.618... Now that I have a method to understand my self, what does it mean that I am here? In other words, I have foundational knowledge in the fact of my existence because I have the ability to define my self, so what does it tell me about my self at present? A desert island thought experiment is used to reach conclusions about life, mortality, choice, and time. How can my sense of self reach the divine proportion? Truth is necessary and honesty is an imperitive in the framework desribed in _living as art._
