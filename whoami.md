...
The following five parts and sub-parts are an attempt to answer the philosophically significant question 'Who am I?' by defining 'I' as a measurable unit in reality. The premise is that in order to answer anything from the philosophically perplexing to the physically insignificant, an 'I' -- that is, an individual, a 'someone'-- is necessary to exist before the self can be asked or respond with an answer to any question. By defining 'I', the self is grounded in present reality by a definable value and, therefore, the self is equipped to answer 'Who am I?'
